...
namespace nv
{
    ...
    public:
        ...
        virtual void drawLabel(const Rect & r, const char * text, const Rect & rt, const int& nbLines, bool isHover, int style,float red, float green, float blue, float alpha) = 0;
        ...
        virtual Rect getProgressBarRect(const Rect & r, Rect& rs, float v, Rect& rc) const = 0;
        virtual void drawProgressBar(const Rect & r, Rect& rs, float vNormalized, float value, Rect& rc, bool isHover, int style) = 0;
    ...
    public:
        ...
        //////////////////////////////////////////////////////////////////
        void doLabel(const Rect & rect, const char * text, int style = 0, float red = 1.0, float green = 1.0, float blue = 1.0, float alpha = 1.0);
        ...
        bool doProgressBar(const Rect & r, float min, float max, float * value, int style = 0);
        bool doProgressBar(const Rect & r, float min, float max, double* value, int style = 0);
